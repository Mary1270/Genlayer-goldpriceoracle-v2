...
loads contract.py once. Same pattern used in OilPriceOracle's test
suite.
"""
...
_spec = importlib.util.spec_from_file_location("goldpriceoracle_contract", _CONTRACT_PATH)
_contract_module = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(_contract_module)

GoldPriceOracle = _contract_module.GoldPriceOracle
gl = _contract_module.gl


def make_contract() -> "GoldPriceOracle":
